...
def command(client: TestClient, headers: dict[str, str], command_type: str, payload: dict, key: str):
    ...
    if command_type.startswith(("CreatePlanning", "UpdatePlanning", "DeletePlanning", "LinkPlanning", "RemovePlanning", "SetPlanning", "AssignPlanning", "LevelPlanning", "BatchPlanning")) and command_type != "CreatePlanningProject":
