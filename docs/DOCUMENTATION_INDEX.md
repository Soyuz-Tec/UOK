...
| `docs/modules/shipments.core/SHIPMENT_SUPPORT_MODULE_PLAN.md` | Shipment Support ownership, stable master-data references, movement lifecycle, Document Type requirement metadata, contracts, and qualification | Shipment ownership, public surface, status or requirement model, data model, UI, or qualification changes |
