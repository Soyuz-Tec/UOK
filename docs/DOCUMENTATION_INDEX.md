...
| `docs/delivery/location-master-slice-design-2026-07-16.md` | Evidence-first design for the tenant-scoped Location Master vertical slice | The Location capability, owner, data model, tenant model, non-goals, or test plan changes |
...
| `docs/delivery/shipment-document-requirements-slice-design-2026-07-17.md` | Approved design for Shipment-owned Document Type requirement metadata and history consumed through the Compliance immutable facade | Requirement-link ownership, status model, Compliance resolver use, tenant model, non-goals, or test plan changes |
| `docs/delivery/shipment-document-requirements-slice-delivery-2026-07-17.md` | Shipment requirement API, data, UI, Compliance DTO proof, freeze compliance, verification, demo, and next-slice handoff | Shipment Document Type requirement delivery evidence, runtime qualification, PR/CI, or residual-risk status changes |
| `docs/delivery/shipment-document-instance-metadata-slice-design-2026-07-17.md` | Approved design for Shipment-owned compliance document-instance metadata without files or binary storage | Instance ownership, lifecycle, requirement synchronization, Compliance resolver use, tenant model, no-binary rules, or test plan changes |
| `docs/delivery/shipment-document-instance-metadata-slice-delivery-2026-07-17.md` | Shipment document-instance metadata API, UI, no-binary and Compliance DTO proof, verification, demo, and next-slice handoff | Instance-metadata delivery evidence, runtime qualification, PR/CI, or residual-risk status changes |
| `docs/delivery/shipment-readiness-signals-slice-design-2026-07-18.md` | Approved design for stateless, tenant-scoped Shipment readiness signals over immutable Shipment owner facts | Intelligence ownership, deterministic signal rules, Shipment facade contract, tenant model, non-goals, or test plan changes |
| `docs/delivery/shipment-readiness-signals-slice-delivery-2026-07-18.md` | Reserved delivery record for the Shipment Readiness API, UI, DTO-only proof, freeze compliance, verification, demo, and next-slice handoff | Shipment Readiness delivery evidence, runtime qualification, PR/CI, or residual-risk status changes |
| `docs/delivery/shipment-document-expiry-readiness-slice-design-2026-07-23.md` | Approved design for explicit-as-of, fixed-UTC, bounded document-expiry readiness over immutable Shipment owner facts | Evaluation date, time-zone policy, warning horizon, eligible instance states, owner aggregate contract, readiness reasons, non-goals, or test plan changes |
| `docs/delivery/shipment-document-expiry-readiness-slice-delivery-2026-07-23.md` | Delivery record for the bounded document-expiry API/UI extension, owner DTO proof, runtime qualification, browser evidence, PR/CI, residual risk, and rollback | Expiry-readiness implementation evidence, runtime qualification, browser proof, exact-head PR/CI, residual-risk status, or rollback evidence changes |
...
| `docs/modules/shipments.core/SHIPMENT_SUPPORT_MODULE_PLAN.md` | Shipment Support ownership, stable master-data references, movement lifecycle, requirement and document-instance metadata, contracts, and qualification | Shipment ownership, public surface, status, requirement, or instance model, data model, UI, or qualification changes |
| `docs/modules/intelligence.core/SHIPMENT_READINESS_SIGNALS_MODULE_PLAN.md` | Stateless Intelligence ownership, deterministic Shipment readiness rules, immutable Shipment dependency, read-only UI, and qualification | Intelligence signal rules, Shipment snapshot contract, permissions, UI, or qualification changes |
...
- `docs/architecture/ADR-0035-request-authoritative-frontend-async-boundary.md`
...
- `docs/modules/intelligence.core/SHIPMENT_READINESS_SIGNALS_MODULE_PLAN.md`
