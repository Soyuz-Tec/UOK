...
- The 35 exact in-process Host request/command adapter imports, including the
  Product Master, Location Master, Route/Corridor Master, and Shipment Support HTTP adapters' `get_db` and `current_actor`
  seams.
