...
server-authoritative list/detail/history reconciliation obligation. Subsequent
sub-slices migrate the other audited module owners in bounded groups. Delivery
