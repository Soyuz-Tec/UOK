...
| Agents begins with governance, not execution | Keep generated plans, approvals, recovery, and evidence in `agents.core`; do not add a live tool/LLM or target-command executor without its own reviewed adapter decision and runtime evidence | `docs/architecture/ADR-0031-governed-agent-runbooks-plans-and-evidence.md` |
