...
| `planning.core` | capability module | Gate A and B runtime-proven; Gate C typed resources runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
