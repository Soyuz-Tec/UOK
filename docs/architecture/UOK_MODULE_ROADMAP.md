...
| `planning.core` | capability module | Gate A-C plus Gate D immutable what-if and reproducible risk analysis runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
