...
| `planning.core` | capability module | Gate A-D plus Gate E measured scale, virtualization, shared localization/RTL, touch, keyboard, and responsive proof runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
