...
| `planning.core` | capability module | Gate A-D stabilization, operation control, resource intelligence, and governed advanced analysis runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
