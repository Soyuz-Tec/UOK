...
| `planning.core` | capability module | Gate A-C and Gate D immutable what-if snapshots runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
