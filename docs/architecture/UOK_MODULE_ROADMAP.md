...
| `planning.core` | capability module | Gate A verified; all five Gate B slices runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
