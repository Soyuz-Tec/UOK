...
| `planning.core` | capability module | Gate A verified; Gate B typed links, execution dates, and task participants runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
