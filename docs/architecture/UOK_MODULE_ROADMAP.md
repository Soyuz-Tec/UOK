...
| `planning.core` | capability module | Gate A/B, typed resources, and Gate C resource calendars runtime-proven | `UOK-3.1.0-alpha.3` | `docs/modules/planning.core/PLANNING_CORE_MODULE_PLAN.md` |
