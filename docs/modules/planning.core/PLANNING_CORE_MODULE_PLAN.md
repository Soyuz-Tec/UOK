...
- traditional Gantt workspace with compact project command bar, grid/timeline, task command toolbar, day/week/month scale controls, today/fit controls, critical and baseline toggles, and tabbed inspector panels
- Gantt bars
