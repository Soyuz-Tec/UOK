...
| Scheduling | Auto scheduling | dependency propagation, calendar rules, manual/auto mode, constraints | Python dependency propagation and project calendar rules exist; constraints/manual mode later | Partial |
