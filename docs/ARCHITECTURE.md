...
- `agents.core` is an optional `integration_tested` capability module for tenant-scoped governed runbooks, generated plan DAGs, deterministic approval policy, human decisions, recovery proposals, and hash-addressed evidence. It declares the `codex` tool binding but does not yet execute Codex, external tools, or target-module commands.
...
- Planning, Contacts, Compliance, Product Master, Location Master, Route/Corridor Master, Shipment Support, and Shipment Readiness expose supported Python facades at `uok_planning_core.public_api`, `uok_contacts_core.public_api`, `uok_compliance_core.public_api`, `uok_product_master.public_api`, `uok_locations_core.public_api`, `uok_routes_core.public_api`, `uok_shipments_core.public_api`, and `uok_intelligence_core.public_api`. All other implementation code is capability-organized below the owner's `_internal` package; external static imports are rejected by `tests/test_module_public_api_boundaries.py`.
- Module-owned ORM mappings remain private even when the model registry resolves their privileged manifest `model_exports` hook. Planning, Contacts, Compliance, Product Master, Location Master, Route/Corridor Master, and Shipment Support export no ORM mapping through a public facade; stateless Intelligence declares no `model_exports` hook.
...
- Static runtime validation completes before extension imports. The host-owned deterministic model registry then composes 59 module-owned mappings with nine kernel mappings (68 total) on the single `uok.kernel.persistence.Base` before migration inspection, schema creation, or router composition. Current closed manifests declare 124 commands, 134 events, 20 exact Host HTTP adapters with 44 exact allowed imports, 12 candidate verifiers, and 11 workbench surfaces.
...
- Product-neutral request authority lives in
  ...
  and history requests. Delivery 6c applies it to all six Compliance commands.
...
- ADR-0031: `docs/architecture/ADR-0031-governed-agent-runbooks-plans-and-evidence.md`
...
- Location Master module plan: `docs/modules/locations.core/LOCATION_MASTER_MODULE_PLAN.md`
- Location Master slice design: `docs/delivery/location-master-slice-design-2026-07-16.md`
- Location Master slice delivery: `docs/delivery/location-master-slice-delivery-2026-07-16.md`
- Route/Corridor module plan: `docs/modules/routes.core/ROUTE_CORRIDOR_MODULE_PLAN.md`
- Route/Corridor slice design: `docs/delivery/route-corridor-slice-design-2026-07-16.md`
- Route/Corridor slice delivery: `docs/delivery/route-corridor-slice-delivery-2026-07-16.md`
- Shipment Support module plan: `docs/modules/shipments.core/SHIPMENT_SUPPORT_MODULE_PLAN.md`
- Shipment Support slice design: `docs/delivery/shipment-support-slice-design-2026-07-17.md`
- Shipment Support slice delivery: `docs/delivery/shipment-support-slice-delivery-2026-07-17.md`
- Compliance Document Type module plan: `docs/modules/compliance.core/COMPLIANCE_DOCUMENT_TYPE_MODULE_PLAN.md`
- Compliance Document Type slice design: `docs/delivery/compliance-document-type-slice-design-2026-07-17.md`
- Compliance Document Type slice delivery: `docs/delivery/compliance-document-type-slice-delivery-2026-07-17.md`
- Shipment Document Requirements slice design: `docs/delivery/shipment-document-requirements-slice-design-2026-07-17.md`
- Shipment Document Requirements slice delivery: `docs/delivery/shipment-document-requirements-slice-delivery-2026-07-17.md`
- Shipment Document Instance Metadata slice design: `docs/delivery/shipment-document-instance-metadata-slice-design-2026-07-17.md`
- Shipment Document Instance Metadata slice delivery: `docs/delivery/shipment-document-instance-metadata-slice-delivery-2026-07-17.md`
