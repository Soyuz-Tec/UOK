...
const messages: Record<UokLocale, Record<string, string>> = {
  "en-US": {
    ...
    "calendar.navigator.label": "Date navigator", "calendar.navigator.open": "Choose date", "calendar.navigator.previousMonth": "Previous month", "calendar.navigator.nextMonth": "Next month", "calendar.navigator.year": "Year", "calendar.navigator.chooseYear": "Choose year", "calendar.navigator.previousYears": "Previous 20 years", "calendar.navigator.nextYears": "Next 20 years", "calendar.navigator.goToYear": "Go to year", "calendar.navigator.go": "Go", "calendar.navigator.backToDates": "Back to dates", "calendar.navigator.yearRangeError": "Enter a year from",
  ...
  ar: {
    ...
    "calendar.navigator.label": "متصفح التاريخ", "calendar.navigator.open": "اختر تاريخا", "calendar.navigator.previousMonth": "الشهر السابق", "calendar.navigator.nextMonth": "الشهر التالي", "calendar.navigator.year": "السنة", "calendar.navigator.chooseYear": "اختر السنة", "calendar.navigator.previousYears": "السنوات العشرون السابقة", "calendar.navigator.nextYears": "السنوات العشرون التالية", "calendar.navigator.goToYear": "الانتقال إلى سنة", "calendar.navigator.go": "انتقال", "calendar.navigator.backToDates": "العودة إلى التواريخ", "calendar.navigator.yearRangeError": "أدخل سنة من",
