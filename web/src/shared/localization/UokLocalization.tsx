...
const messages: Record<UokLocale, Record<string, string>> = {
  "en-US": {
    ...
    "calendar.navigator.label": "Date navigator", "calendar.navigator.open": "Choose date", "calendar.navigator.previousMonth": "Previous month", "calendar.navigator.nextMonth": "Next month", "calendar.navigator.year": "Year",
  ...
  ar: {
    ...
    "calendar.navigator.label": "متصفح التاريخ", "calendar.navigator.open": "اختر تاريخا", "calendar.navigator.previousMonth": "الشهر السابق", "calendar.navigator.nextMonth": "الشهر التالي", "calendar.navigator.year": "السنة",
