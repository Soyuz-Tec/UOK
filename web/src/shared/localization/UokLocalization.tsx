...
const messages: Record<UokLocale, Record<string, string>> = {
  "en-US": {
    ...
    "command.delete": "Delete", "command.close": "Close", "command.workspaceEditor": "Workspace editor", "command.noSavedSearches": "No saved searches yet.", "command.clearAll": "Clear all", "command.done": "Done",
  ...
  ar: {
    ...
    "command.delete": "حذف", "command.close": "إغلاق", "command.workspaceEditor": "محرر مساحة العمل", "command.noSavedSearches": "لا توجد عمليات بحث محفوظة بعد.", "command.clearAll": "مسح الكل", "command.done": "تم",
