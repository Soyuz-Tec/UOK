...
`planning.core` is the optional UOK project planning capability module. It owns project schedules, task dependencies, planned/forecast/actual/deadline semantics, schedule validation, Gantt read models, and module-local candidate verification.
