...
import { PlanningAnalysisPanel } from "../../web/src/PlanningAnalysisPanel";
import { listPlanningRecommendations, listPlanningRiskAnalyses, listPlanningWhatIfSnapshots, loadPlanningWhatIfSnapshot } from "../../web/src/planningAnalysisApi";
import type { PlanningSchedule } from "../../web/src/types";

vi.mock("../../web/src/planningAnalysisApi", () => ({
