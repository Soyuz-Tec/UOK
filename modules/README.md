...
| `shipments.core` | Optional tenant-scoped operational Shipment headers and auditable movement lifecycle over immutable Party, Location, and Route owner references. |
