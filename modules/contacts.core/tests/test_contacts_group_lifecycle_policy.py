...
from uok_contacts_core.group_read_model import serialize_contact_group
from uok_contacts_core.models import ContactGroup
...
def test_contact_group_lifecycle_projection_uses_exact_command_permissions(client: TestClient, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "uok.security.effective_role_permissions",
        lambda: {
