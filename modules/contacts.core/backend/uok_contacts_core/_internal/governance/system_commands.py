from uok_contacts_core._internal.governance.extension_commands import (
    cmd_define_contact_custom_field,
    cmd_link_external_identity,
    cmd_set_contact_custom_field,
)
from uok_contacts_core._internal.registry.fact_commands import (
    cmd_remove_contact_fact,
    cmd_upsert_contact_fact,
    normalized_fact_value,
    sync_legacy_payload_facts,
)
from uok_contacts_core._internal.governance.governance_commands import (
...
from uok_contacts_core._internal.exchange_quality.quality_commands import (
    cmd_bulk_contacts,
